...
Ý tưởng bài toán rất đơn giản, ta sử dụng đến thuật toán DFS để kiểm tra. Ta sẽ bắt đầu DFS từ vị trí lối vào của mê cung, với mỗi vị trí $\left(i, j\right)$ trong mê cung $M$, nếu $M[i][j] = $ '.', ta sẽ DFS từ $M$ ra xung quanh vị trí $\left(i, j \right)$ đó. 
